...
#+end_src
#+begin_export latex
\epr In the registerRoutes function set the global docsPrefix before we handle routes later on.
#+end_export
...
#+begin_export latex
\subsection{Files}
We serve two kinds of files. Style files and data files.
#+end_export
#+begin_src go <<Serve files, Pa. \ref{pa:nev}>>=
  //<<Serve style files, Pa. \ref{pa:nev}>>
  //<<Serve data files, Pa. \ref{pa:nev}>>
#+end_src
#+begin_export latex
...
#+end_export
#+begin_src go <<Serve style files, Pa. \ref{pa:nev}>>=
...
#+end_export
#+begin_src go <<Serve data files, Pa. \ref{pa:nev}>>=
...
assigned prefix. The list of services is potentially long, so we sort it. We also
set the number of taxa and genomes, and when the database was last updated.
#+end_export
...
#+end_src
#+begin_export latex
We set the declare the fields \ty{ApiPrefix}, \ty{DocsPrefix}, \ty{Services} and \ty{Title} in
``Neighbors''.
#+end_export
...
#+begin_src html <<List data sources, Pa. \ref{pa:nev}>>=
  ...
  <a href="https://neighbors.evolbio.mpg.de/data/neidbData.tgz">
    here</a>, the much larger sqlite database itself is
  <a href="https://neighbors.evolbio.mpg.de/data/neidb">
    here</a>.
#+end_src
#+begin_export latex
