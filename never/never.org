...
#+end_export
#+begin_src go <<Store taxids, Pr. \ref{pr:nev}>>=
...
#+end_export
#+begin_src go <<Get images, Pr. \ref{pr:nev}>>=
  var neiImages []Image
...
#+begin_src go <<Add start node, Pr. \ref{pr:nev}>>=
  ...
  util.Check(err)
  //<<Is start node root?, Pr. \ref{pr:nev}>>
...
#+end_export
#+begin_src go <<Is start node root?, Pr. \ref{pr:nev}>>=
